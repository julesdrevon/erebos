...
import ApiDataFetcher from '@/app/components/apifetcher';

<ApiDataFetcher endpoint="mon-endpoint" params={{ page: '1', limit: '10' }} />
      ...
      <div className="flex flex-col justify-center items-center h-full gap-8">
        ...
        <div className="border-2 border-gold relative py-6 px-8 bg-zinc-800/40 w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col justify-center items-center gap-6 w-full">
            ...
            <button
              type="submit"
              className="flex justify-center items-center gap-2 bg-gold text-black w-full rounded p-2.5 uppercase text-sm hover:cursor-pointer hover:bg-opacity-80 transition-all duration-300"
            >
